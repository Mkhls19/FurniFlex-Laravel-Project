...
<body>
    <nav>
        ...
        <img src="{{asset('style/assets/image/logofrnflx2.png')}}" alt="Logo Furniflex" width="30%" class="logo"/>
    ...
    <div class="wrapper">
        ...
        <div class="slides"> 
            <div class="slide"> 
                <img src="{{asset('style/assets/image/kursi2.png')}}" alt="Gambar 1"> 
            </div> 
            <div class="slide"> 
                <img src="{{asset('style/assets/image/meja2.png')}}" alt="Gambar 2"> 
            </div> 
            <div class="slide"> 
                <img src="{{asset('style/assets/image/rak2.png')}}" alt="Gambar 3"> 
            </div> 
            <div class="slide"> 
                <img src="{{asset('style/assets/image/meja3.png')}}" alt="Gambar 4"> 
            </div> 
            <div class="slide"> 
                <img src="{{asset('style/assets/image/kursi3.png')}}" alt="Gambar 5"> 
            </div> 
        ...
        <section id="produk">
            <div class="tengah">
                ...
                <div class="kartu-produk" id="produk1">
                    <img src="{{asset('style/assets/image/meja1.jpg')}}"/>
                    <p>Meja</p>
                </div>
                <div class="kartu-produk" id="produk2">
                    <img src="{{asset('style/assets/image/kursi1.jpg')}}"/>
                    <p>Kursi</p>
                </div>
                <div class="kartu-produk" id="produk3">
                    <img src="{{asset('style/assets/image/lemari1.jpg')}}"/>
                    <p>Lemari</p>
                </div>
                <div class="kartu-produk" id="produk4">
                    <img src="{{asset('style/assets/image/rak1.jpg')}}"/>
                    <p>Rak Sepatu</p>
                </div>
            </div>
        </div>
